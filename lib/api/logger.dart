...
class Logger {
  static void logException(dynamic e, StackTrace? stackTrace,
      {String? function, String? bodySent, String? extraInformation}) async {
  ...
  static void logUnknownError(String code, String response,
      {String? function, String? bodySent, String? extraInformation}) async {
    if (GeneralConfiguration.get.errors_log) {
      print('-------------------------------------');
